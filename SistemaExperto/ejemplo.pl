...
pregunta_carrera(Ingeniero_Informatico):-
...
pregunta_carrera(Ingeniero_Estadistico):-
...
pregunta_carrera(Licenciado_en_Fisica):-
...
pregunta_carrera(Licenciado_en_Matematicas):-
...
pregunta_carrera(Biologo_Microbiologo):-
...
pregunta_carrera(Biologo_Pesquero):- 
...
pregunta_carrera(Licenciado_en_Administracion):- 
...
pregunta_carrera(Contador_Publico):-
...
pregunta_carrera(ccomunicacion):-
...
pregunta_carrera(Medico_Cirujano):-
...
pregunta_carrera(Antropologo_Social):-
...
pregunta_carrera(Trabajador_Social):-
...
pregunta_carrera(Licenciado_En_Turismo):-
...
pregunta_carrera(Licenciado_En_Historia):-
...
pregunta_carrera(Quimico_Farmaceutico):-
...
pregunta_carrera(Ingeniero_Industrial):-
    ...
    pregunta('¿Tienes inclinaciones y destreza para manipular aparatos, equipos y sustancias en laboratorios?').
pregunta_carrera(Ingeniero_Mecanico):-
...
pregunta_carrera(Ingeniero_Metalurgico):-
...
pregunta_carrera(Ingeniero_de_Sistemas):-
...
pregunta_carrera(Ingeniero_de_Materiales):-
...
pregunta_carrera(Ingeniero_de_Minas):-
...
pregunta_carrera(Ingeniero_Mecatronico):-
...
pregunta_carrera(Ingeniero_Quimico):-
...
pregunta_carrera(Ingeniero_Ambiental):-
